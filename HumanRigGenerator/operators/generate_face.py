...
def generate_face_bones(arm_data, gender="MALE", marker_positions=None):
    ...
    # Curved Eyelid Arc Support Points (distributes bones along the eyelid curve to eliminate triangular pinching)
    ...
    # Generate DEF- bones for both sides parented to deform anchors (face_root/mouth_root)
    for side in [".L", ".R"]:
